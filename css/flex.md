...
| Title | Content |
| :--- | :--- |
| nowrap \(**defalut**\) | 모든 item 여러 줄 묶지 않고, 한 줄에 표 |
| wrap | item 여러 줄 묶 |
...
| flex-end | item를 끝점으로 정 |
| center | item를 가운데 정 |
| space-between | item를 시작점 끝점에 정렬하고, 나머지 item은 사이에 고르게 정 |
| space-around | item를 군등한 여백을 포함하여 정 |
...
| flex-basis \(defalut : auto\)  | item의 공간 배분 전, 기본 너비 설 |
...
| Title | Content |
| :--- | :--- |
| auto \(defalut : auto\) |  container의 `align-item` 속성을 상속 받 |
| stretch | container의 교차 축을 채우기 위해 Item을 늘림 |
| flex-start | item를 각 줄의 시작점으로 정렬 |
| flex-end | item를 각 줄의 끝점으로 정 |
| center | item를 가운데 정 |
| baseline | item를 문자 기준선에 정 |
